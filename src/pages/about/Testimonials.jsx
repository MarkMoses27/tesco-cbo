...
The transformation has been miraculous. Where we once saw only burden, we now celebrate small victories - Binti's first intentional smile, her sister's improved grip strength. Our marriage has been reborn through shared purpose. We've even become advocates, speaking at community meetings to combat disability stigma. As my wife says: "We went from hiding our girls to celebrating their unique light."`,
    ...
    {
      id: 2,
      title: "Brighton's Battle Against Hydrocephalus",
...
The 8-hour surgery was successful. At 18 months old, Brighton is hitting developmental milestones - sitting unaided, babbling, and recognizing family members. His mother Mary now volunteers as a TESCO parent ambassador: "That shunt isn't just medical plastic - it's a lifeline. TESCO didn't just save Brighton; they saved our family from disintegration. We're paying it forward by helping 7 other families access care."`,
    ...
    {
      id: 3,
      title: "Rehema: From Darkness to Distinction",
      excerpt: "Blind girl's educational triumph against all odds",
      content: `Rehema lost her sight to measles at age 3. When her father abandoned the family, blaming her disability, she dropped out of school after just one year. For a decade, she remained homebound - until TESCO's community scouts identified her case during a door-to-door survey.

Our comprehensive intervention:
✓ Full scholarship to Thika School for the Blind
...
At 17, Rehema excels academically (top 10% class rank) and leads the school choir. Her mother Wanjiku shares: "I cried when she read me braille letters. My daughter who I carried like a baby now teaches me!" Rehema aims to become Kenya's first blind Supreme Court Justice, proving disability ≠ inability.`,
    ...
    {
      id: 4,
      title: "Siblings Emerge From Shadows",
      excerpt: "Special education transforms isolated siblings",
      content: `We discovered 18-year-old Elijah chained in a dark shed, naked and surrounded by feces. His 13-year-old sister Malaika hadn't spoken in 7 years. Both have severe autism and intellectual disabilities, hidden by relatives ashamed of their conditions.

TESCO's 360° intervention:
• Emergency rescue & medical stabilization
• Enrollment in Joytown Special School
• Adaptive equipment (communication boards, sensory tools)
• Daily living skills training
• Speech therapy for Malaika

After 18 months:
- Elijah feeds/dresses himself and tends a vegetable garden
- Malaika uses 50+ Makaton signs and sings in choir
- Both participate in classroom activities
- Family reunited through counseling

Their uncle Kamau reflects: "We thought they were cursed. Now we see they're angels teaching us compassion. Elijah's tomatoes feed our family - his disability became our blessing."`,
      category: 'education',
      author: 'Care Team',
      date: '2023-12-05'
    },
    {
      id: 5,
      title: "Khadija Breaks the Curse Myth",
      excerpt: "From outcast to classroom leader",
...
Khadija proudly states: "I'm not sick - I'm special. My brain just dances differently!" Her success inspired 7 families to seek help for disabled children.`,
    ...
    },
    {
      ...
      excerpt: "Village rejects stigma, embraces inclusion",
      content: `In Murang'a County, 72% of disabled children were hidden in homes. TESCO launched:
